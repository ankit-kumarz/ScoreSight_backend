"""Django settings for scoresight_backend project (minimal for REST API)."""
...
ROOT_URLCONF = 'scoresight_backend.urls'
...
WSGI_APPLICATION = 'scoresight_backend.wsgi.application'
